...
pub(crate) const CALLBACK_PROGRAM_ID: pinocchio::Address =
...
pub(crate) const CALLBACK_SIGNER: pinocchio::Address =
    pinocchio::Address::new_from_array(CALLBACK_SIGNER_PDA.0);
