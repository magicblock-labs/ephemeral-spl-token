...
///
#[inline(always)]
pub fn process_initialize_rent_pda(accounts: &[AccountView], instruction_data: &[u8]) -> ProgramResult {
    let [
    ...
    require!(rent_pda_info.lamports() == 0, ProgramError::InvalidAccountData);
